#!/bin/bash
sqlite sandesha2 "drop table create_seq;"
sqlite sandesha2 "drop table  invoker;"
sqlite sandesha2 "drop table  sender"
sqlite sandesha2 "drop table  next_msg"
sqlite sandesha2 "drop table  seq_property"
sqlite sandesha2 "drop table  msg"
sqlite sandesha2 "create table create_seq(create_seq_msg_id varchar(100) primary key, 
    internal_seq_id varchar(200), seq_id varchar(200), create_seq_msg_store_key varchar(100),
    ref_msg_store_key varchar(100))"
sqlite sandesha2 "create table invoker(msg_ctx_ref_key varchar(100) primary key, 
    msg_no long, seq_id varchar(200), is_invoked boolean)"
sqlite sandesha2 "create table sender(msg_id varchar(100) primary key, 
...
sqlite sandesha2 "create table next_msg(seq_id varchar(200) primary key, 
    ref_msg_key varchar(100), polling_mode boolean, msg_no long)"
sqlite sandesha2 "create table seq_property(id varchar(200) primary key, 
    seq_id varchar(200), name varchar(200), value varchar(200))"
sqlite sandesha2 "create table msg(stored_key varchar(200) primary key,
